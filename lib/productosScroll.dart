...
class ProductosScroll extends StatelessWidget {
...
class TiendaScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView( // Aquí se agrega SingleChildScrollView
        child: Column( // Usamos Column para apilar los widgets verticalmente
          children: [
            ListView.builder(
              shrinkWrap: true, // Permite que el ListView ocupe el espacio necesario
